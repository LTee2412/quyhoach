...
def main():
    ...
    backbone, link_path_count, link_cost, link_cost_changed, link_usage = Mentor_2.Mentor2_ISP(
    ...
    Mentor_2.plot_backbone(ListPosition, Mentor_2.prim_dijkstra_backbone_links(ListPosition, [n for n in ListPosition if n.get_name() in backbone]), args.max)
    plt.show()
